class Account:
    ...
    def withdraw(self, amount):
        ...
        print("Insufficient funds") #não é mais necessário usar else
        return False

    def get_balance(self):
        return self.balance
    
    def checkBalance(self, amount): #Função para verificar saldo
...
class Bank:
    ...
    def transfer(self, from_account, to_account, amount):
        if from_account.withdraw(amount): #Execetuva a transação mesmo se a conta de origem não possuise fundos
...
def main():
    ...
    # Perform a transfer
    my_bank.transfer(alice_account, bob_account, 1100)
